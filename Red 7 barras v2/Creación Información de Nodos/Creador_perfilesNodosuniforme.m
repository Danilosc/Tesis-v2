...
clear all
%% Info de nodos
[~, ~, raw] = xlsread('C:\Users\danil\OneDrive\Escritorio\Version Definitiva\Red 7 barras v2\Datos DSS\Feeder_Data.xlsx','Nodes','C2:C8');
...
PerfilesEVAnual_rapido = importar('C:\Users\danil\OneDrive\Escritorio\Version Definitiva\Red 7 barras v2\Modelo Carga EV\Casos\Perfiles_EV_rapido' + caso + '.csv',1,8760);
PerfilesEVAnual_domicilio = importar('C:\Users\danil\OneDrive\Escritorio\Version Definitiva\Red 7 barras v2\Modelo Carga EV\Casos\Perfiles_EV_domiciliario' + caso + '.csv',1,8760);
user_EV = importar('C:\Users\danil\OneDrive\Escritorio\Version Definitiva\Red 7 barras v2\Modelo Carga EV\Casos\user_EV' + caso + '.csv',1,1);
porc_ev = [25 50 75]/100;
a1 = input('Guardar datos (s/n) ','s');
%% distancias coordenadas
[~, ~, raw] = xlsread('C:\Users\danil\OneDrive\Escritorio\Version Definitiva\Red 7 barras v2\Datos DSS\coordenadas.xlsx','Hoja1','A2:C08');
...
xlswrite('C:\Users\danil\OneDrive\Escritorio\Version Definitiva\Red 7 barras v2\Creación Información de Nodos\coordenadas'+caso+'.xlsx',coordenadas);
xlswrite('C:\Users\danil\OneDrive\Escritorio\Version Definitiva\Red 7 barras v2\Creación Información de Nodos\distancia_real'+caso+'.xlsx',distancia_real);  
%% ploteo Red
plot(coordenadas(1:7,2),coordenadas(1:7,3),'-or')
hold on
for i = 1:1:7
    text(coordenadas(i,2),coordenadas(i,3),string(coordenadas(i,1)))
end
%% EVs x nodos caso 100%
filename = 'C:\Users\danil\OneDrive\Escritorio\Version Definitiva\Red 7 barras v2\Datos DSS\N_clientes.csv';
delimiter = ',';
...
clientes_nodos = clientes_nodos(~isnan(clientes_nodos));
...
perfil_nodoEV_domGA100 = zeros(8760,6);
...
for x = 1:1:length(porc_ev) %contador casos de probabilidad penetracion
    ...
    perfil_nodoEV_domGA = zeros(8760,6);
    ...
    if a1 == 's' 
        ...
        csvwrite('C:\Users\danil\OneDrive\Escritorio\Version Definitiva\Red 7 barras v2\Creación Información de Nodos\'+ casostr+ '\posicion_EV'+caso+'_EV'+string(porc_ev(x)*100)+'.csv',posicion_EV);
        ...
        csvwrite('C:\Users\danil\OneDrive\Escritorio\Version Definitiva\Red 7 barras v2\Creación Información de Nodos\'+ casostr+ '\perfil_nodoEVGA_rapido'+caso+'_EV'+string(porc_ev(x)*100)+'.csv',perfil_nodoEVGA);
        csvwrite('C:\Users\danil\OneDrive\Escritorio\Version Definitiva\Red 7 barras v2\Creación Información de Nodos\'+ casostr+ '\perfil_nodoEVGA_dom'+caso+'_EV'+string(porc_ev(x)*100)+'.csv',perfil_nodoEV_domGA);
        csvwrite('C:\Users\danil\OneDrive\Escritorio\Version Definitiva\Red 7 barras v2\Creación Información de Nodos\'+ casostr+ '\suma_clientes_ev'+caso+'_EV'+string(porc_ev(x)*100)+'.csv',sum_clientes_ev);
        ...
        csvwrite('C:\Users\danil\OneDrive\Escritorio\Version Definitiva\Red 7 barras v2\Creación Información de Nodos\'+ casostr+ '\idvehiculo'+caso+'_EV'+string(porc_ev(x)*100)+'.csv',idvehiculo);
    end  
end 
