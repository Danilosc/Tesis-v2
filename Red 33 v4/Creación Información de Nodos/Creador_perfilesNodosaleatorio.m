...
clear all
%% Info de nodos
[~, ~, raw] = xlsread('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Version Definitiva\Red 33 v4\Datos DSS\Feeder_Data.xlsx','Nodes','C2:C34');
...
[~, ~, raw] = xlsread('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Version Definitiva\Red 33 v4\Datos DSS\coordenadas.xlsx','Hoja1','A2:C34');
...
filename = 'C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Version Definitiva\Red 33 v4\Datos DSS\N_clientesAlea.csv';
delimiter = ',';
...
for x = 1:1:length(porc_ev) %contador casos de probabilidad penetracion
    ...
    if a1 == 's' 
        casostr = caso + '_EVAL' + string(porc_ev(x)*100);
        mkdir(char(casostr))
        ...
        csvwrite('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Version Definitiva\Red 33 v4\Creación Información de Nodos\'+ casostr+ '\posicion_EV'+caso+'_EVAL'+string(porc_ev(x)*100)+'.csv',posicion_EV);
        ...
        csvwrite('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Version Definitiva\Red 33 v4\Creación Información de Nodos\'+ casostr+ '\perfil_nodoEVGA_rapido'+caso+'_EVAL'+string(porc_ev(x)*100)+'.csv',perfil_nodoEVGA);
        csvwrite('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Version Definitiva\Red 33 v4\Creación Información de Nodos\'+ casostr+ '\perfil_nodoEVGA_dom'+caso+'_EVAL'+string(porc_ev(x)*100)+'.csv',perfil_nodoEV_domGA);
        csvwrite('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Version Definitiva\Red 33 v4\Creación Información de Nodos\'+ casostr+ '\suma_clientes_ev'+caso+'_EVAL'+string(porc_ev(x)*100)+'.csv',sum_clientes_ev);
        ...
        csvwrite('C:\Users\dany_\Desktop\New tesis\Simulaciones Tesis\Version Definitiva\Red 33 v4\Creación Información de Nodos\'+ casostr+ '\idvehiculo'+caso+'_EVAL'+string(porc_ev(x)*100)+'.csv',idvehiculo);
    end  
end 
